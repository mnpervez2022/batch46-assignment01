...
if (vehicle === 'Four wheel') {
    console.log(' i like to drive four wheel "Anwer should be true b/c i hardcode vehicle value is 4 wheel"');
    } else {
...
if (color !== 'Black') {
    ...
    console.log(' i donot like other than black color "Anwer should be false b/c i hardcode color value is black"') 
}
if (capacity === '4 persons') {
    console.log(' Car capacity is not sutable for my family ')
} else {
    console.log(' Car capacity should be 8 persons  "Anwer should be false b/c capacity value is 8 persons"')  
}
if (drive === 'Right hand') {
